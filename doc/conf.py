# -*- coding: utf-8 -*-
#
# OpenModes documentation build configuration file, created by
...
project = u'OpenModes'
copyright = u'2012-2017, David Powell'
...
htmlhelp_basename = 'OpenModesdoc'
...
latex_documents = [
  ('index', 'OpenModes.tex', u'OpenModes Documentation',
...
man_pages = [
    ('index', 'openmodes', u'OpenModes Documentation',
     [u'David Powell'], 1)
]
...
texinfo_documents = [
  ('index', 'OpenModes', u'OpenModes Documentation',
   u'David Powell', 'OpenModes', 'One line description of project.',
   'Miscellaneous'),
]
